...
\begin{document}
	...
	\end{thm}
	\begin{proof}
		On se donne $E$ tel que $\min E \leqslant x$. \\
		Pour $k\in E$, on a $\min E \leqslant k$. Or $\min E \leqslant x$, d'où par transitivité (je crois) $x \leqslant k$. \\
		Ceci est en particulier vrai pour $k = \min E$, ie $x \leqslant \min E$, d'où par double inégalité $x = \min E$
	\end{proof}
	...
	\textbf{Remarque 3}: À ne pas confondre avec le théorème (classique!) affirmant qu'un minorant est également minimum. \\ \\
