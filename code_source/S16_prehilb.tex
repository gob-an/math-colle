...
\begin{document}
	...
	\textbf{pas certaine que ça fonctionne, fiez vous à la correction officielle}\\
	...
	\begin{correctionbox}
		...
		Si $a$ et $b$  sont liés, alors $b = \beta a$. En notant $x= \lambda a + x'$, avec $x'$ orthogonal à $a$, $\lambda^2 \leqslant 1$ (pour que $x$ soit unitaire), on obtient $f(x) = \lambda^2\beta\|a\|^2$,  d'où une borne supérieure (si $\beta \geqslant 0$) de $\beta\|a\|^2 = \|a\|\|b\|$ (atteinte en $x = \frac 1 {\|a\|} a$), et une borne inférieure de 0 (pour $x$ normal à $a$) \\
		...
		Puisque $u$, $v$ forment une famille libre, il existe $w$ isométrie tq $e_1 = \frac  1 {\|u\|^2} w(u)$, $e_2=\frac  1 {\|v\|^2} w(v)$ forment une famille orthonormée. \\
		...
		On note alors $x = \lambda e_1 + \mu e_2 + x'$, avec $x'$ normal à $w(u)$, $w(v)$ ($x$ est unitaire, donc $\lambda^2 + \mu^2 + \|x'\|^2 = 1$). \\
		Dès lors, $f(x) = \lambda^2 \|u\|^2 - \mu^2 \|v\|^2$, d'où il découle immédiatement une borne supérieure atteinte en $w(u)$ de $\|u\|=-\frac 1 2 \|a+b\|$, et une borne inférieure en $w(v)$ de  $\frac 1 2 \|a-b\|$.
	\end{correctionbox}
