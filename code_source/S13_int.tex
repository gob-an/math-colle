...
\begin{document}
	...
	\begin{enumerate}
		...
		\begin{correctionbox}
			...
			\\
			De plus, $u_n = \displaystyle \int_{0}^{+\infty} f_n + \mathrm o(1)$ (en effet, $u_n$ est l'intégrale partielle de $f_n$). \textbf{pas sûre que ce soit légal... à rédiger proprement.} \\
