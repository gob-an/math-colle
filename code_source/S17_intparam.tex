...
\begin{document}
	...
	\begin{enumerate}[a)]
		...
		\begin{correctionbox}
			...
			$$f'(t) = -\int_0^{+\infty} t e^{-xt} \sin \sqrt t$$
		\end{correctionbox}
		...
		\begin{correctionbox}
			Par le changement de variable $u=\sqrt t$ ($u^2=t, dt = 2u\,du$, et la racine carrée est bien $\Co[1]$ bijective), on obtient:
			...
			\begin{align*}
				f(x) & = -2[ue^{-xu^2}\cos u]_0^{+\infty} & + & 2\int_0^{+\infty} (1-2xu^3)e^{-xu^2} \cos u \,du \\
				& = 0 & + & 2\int_0^{+\infty} (1-2xu^3)e^{-xu^2} \cos u \, du \\
				& = [(1-2xu^3) e^{-xu^2}\sin u]_0^{+\infty} & + & \int_0^{+\infty} (-4xu+4x^2 u^3) e^{-xu^2} \sin u \, du \\
				& = 0 & + & 4xf(x) - 4x^2f'(x)
			\end{align*}
	...
	\begin{enumerate}[a)]
		...
		\begin{correctionbox}
			...
			Si $x\leqslant 0$, on a: \begin{align*}
				\int_0^{+\infty}e^{-xt} \frac {\sin x} x dx & \geqslant \int_0^{+\infty} \frac {\sin x} x dx \\
