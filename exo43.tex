...
\begin{document}	
	...
	Cette correction se repose sur \underline{Introduction à la théorie de Galois}\footnote{https://www.cmls.polytechnique.fr/perso/laszlo/galois/galois.pdf}, par Yves Laszlo, et d'un théorème très puissant qui résout l'exercice tout seul, trouvé sur \url{wikipedia.org} (on fait avec les sources qu'on trouve, et avec la flemme qu'on a).
	\\
	...
	En trigonalisant dans $ M_n (\mathbb C) $, on remarque que la trace est alors strictement négative (de valeur $-m_1 - m_j$), ce qui est absurde: l'ensemble des matrices convenant est $\emptyset$.

	\section{Irréductibilité de $P$ dans $\mathbb Q [X]$}
	$P$ est unitaire, donc, d'après le lemme de Gauss, si celui-ci est réductible dans $\mathbb Q[X]$, alors il est réductible dans $\mathbb Z [X]$.\\
